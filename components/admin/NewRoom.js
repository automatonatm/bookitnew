...
import {clearErrors, createRoom} from "../../redux/actions/adminRoomActions";
import {CREAT_ROOM_RESET} from "../../redux/constants/roomConstants";
...
const NewRoom = () => {
    ...
    const {loading, errors, success} = useSelector(state => state.adminRooms);
    ...
    useEffect(() => {
        ...
        if (success) {
            ...
            dispatch({type: CREAT_ROOM_RESET})
        }
        if (errors) {
            toast.error(errors)
                ...
                <div className="col-10 col-lg-8">
                    <form className="shadow-lg" encType="multipart/form-data" onSubmit={submitHandler}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" id="category_field" name="category"  onChange={onchangeHandler}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" id="guestCapacity_field" name="guestCapacity"  onChange={onchangeHandler}>
                                {
                                    [1, 2, 3, 4, 5, 6].map(num => (
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" id="numOfBeds_field" name="numOfBeds"  onChange={onchangeHandler}>
                        ...
                        <button type="submit" className="btn btn-block new-room-btn py-3" disabled={loading}>
